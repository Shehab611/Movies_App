...
class GetNowPlayingMovies  extends BaseUseCase<List<Movies>,NoParameter>{
  final BaseMoviesRepositry moviesRepositry;

  GetNowPlayingMovies(this.moviesRepositry);

  @override
  Future<Either<ServerException,List<Movies>>> call(NoParameter parameters)async{

    return await moviesRepositry.getNowPlaying();
  }
}
...
class GetTopRatedMovies extends BaseUseCase<List<Movies>,NoParameter>{
  final BaseMoviesRepositry moviesRepositry;

  GetTopRatedMovies(this.moviesRepositry);

  @override
  Future<Either<ServerException,List<Movies>>> call(NoParameter parameters)async{

    return await moviesRepositry.getTopRatedMovies();
  }
}